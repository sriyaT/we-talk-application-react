...
class Dashboard extends React.Component{
        ...
        return( 
            <div>
                ...
                </ChatList>
                {
                    ...
                    null :
                    <ChatView user={this.state.email} chat={this.state.chats[this.state.selectedChat]}></ChatView>
                }
                {
                    this.state.selectedChat !== null && !this.state.newChatFromVisible ? 
                    <ChatTextBox messageReadFn = {this.messageRead}submitMessageFn={this.submitMessage}></ChatTextBox> :
                    null
                }
                {
                    this.state.newChatFromVisible ? <NewChat goToChatFn={this.goToChat} newChatSubmitFn = {this.newChatSubmit}></NewChat> : null
                }
    ...
    selectChat = async (chatIndex) =>{
        await this.setState({ selectedChat : chatIndex, newChatFromVisible: false });
        this.messageRead();
    }
    ...
    newChatBtnClicked = () =>{
     ...
     goToChat  = async (docKey, msg) =>{
        ...
        this.setState({ newChatFromVisible: false});
