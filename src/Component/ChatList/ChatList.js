...
class ChatList extends React.Component{
    render(){
        ...
        if( this.props.chats.length > 0){
                    ...
                    <List>
                        {
                            this.props.chats.map((_chat, _index) => {
                                return(
                                    ...
                                    {
                                        _chat.reciverHasRead === false && !this.userIsSender(_chat) ?
                                        <ListItemIcon>
            ...
            return(
                <main className={classes.root}>
                <Button variant='contained' fullWidth color = 'primary' onClick={this.newChat} className={classes.newChatBtn}>New Message</Button>
                <List></List>
                </main>
                )
